...
RFI=0.35            # arg 6  =  RFI Scale                   In beamwidths
Wgt=0.33            # arg 7  =  Weight Scale                ...
TS=1                # arg 8  =  Time Shifting               1 or 0 corresponds to on/off
Raw=0               # arg 9  =  Raw                         1 or 0 corresponds to on/off (Generate a raw map of the originial datafile)
LSS=0               # arg 10 =  LSS                         1 or 0 corresponds to large scale structures (LSS)/small scale structures (SSS)
Phot=1              # arg 11 =  Photometry on               1 or 0 corresponds to on/off
...
do
    ...
    ./radio-cartographer $file $Coord $Channel $Cali $Bg $RFI $Wgt $TS $Raw $LSS $Phot $Apt $Ann $Fd $Loc $Trm $M10
