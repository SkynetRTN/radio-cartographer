...
namespace Tools
{
	...
	double convertToDec(double, double);
	double convertToRa(double, double);
	double convertToB(double, double);
	double convertToL(double, double);
	...
	std::vector<double> concatenate(const std::vector<double>&, const std::vector<double>&);
}
